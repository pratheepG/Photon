...
@Configuration
@EnableConfigurationProperties({ GatewayXaProps.class })
public class GatewayDbConfig {

//    @Bean(name = "gatewayDataSource")
//    public DataSource gatewayDataSource(XADataSourceWrapper wrapper, GatewayXaProps props) throws Exception {
...
//    }
    ...
    @Bean(name = "gatewayDataSource")
    public DataSource gatewayDataSource(GatewayXaProps props) {
    ...
    public LocalContainerEntityManagerFactoryBean gatewayEmf(EntityManagerFactoryBuilder builder, @Qualifier("gatewayDataSource") DataSource ds) {

        return builder
                .dataSource(new TransactionAwareDataSourceProxy(ds))
                .packages("com.photon.console.gateway.entity")
